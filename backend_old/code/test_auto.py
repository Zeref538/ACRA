...
result, metrics = run_full_pipeline(img, 1.0, "deutan")

# Check that grey pixels didn't crush to black
...
img2[:100, :100] = [200, 50, 50]   # Red
img2[:100, 100:200] = [50, 200, 50]  # Green
img2[:100, 200:] = [50, 50, 200]   # Blue
img2[100:200, :] = [180, 180, 50]  # Yellow
img2[200:, :100] = [128, 128, 128] # Grey
img2[200:, 100:200] = [255, 255, 255] # White
img2[200:, 200:] = [40, 40, 40]    # Dark grey

result2, metrics2 = run_full_pipeline(img2, 1.0, "deutan", n_clusters=50)
...
_, m3a = run_full_pipeline(solid, 1.0, "deutan")
...
_, m3b = run_full_pipeline(poster, 1.0, "deutan")
